...
export default function Cr_box({tableNumber}){
    const display_filled = "El índice de consistencia actual es:"
    const display_notfilled = "Complete la matriz de opciones para ver la relación de consistencia."
    ...
    return(
       ...
       <p class="heading"><h1 class="heading">Relación de consistenica</h1></p> 
         <div class="info">
