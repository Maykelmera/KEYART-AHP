  ...
  for (let i = 0; i < altValue; i++) {
    altForm.push(
      <div className="top_element crit_element my-2">
        {
          <>
            <label>Alternativa No. {i + 1}: </label>
            <input
              className="input_box border-2 px-1.5 rounded-md"
  ...
  return (
    <>
      <div className="h-10">
        ...
        >
          Editar los nombres de los criterios y alternativas
        </button>
      </div>
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    ...
                    ¡Evite usar nombres más largos! En su lugar, usa nombres cortos.
                    </p>
                    <div>{critForm}</div>
                    <hr/>
                    <div>{altForm}</div>
                  ...
                  <div className="mt-4">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-red-700 px-4 py-2 text-sm font-medium text-white-900 hover:bg-red-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
